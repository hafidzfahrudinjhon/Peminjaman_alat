...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    //CRUD Peminjaman
    Route::get('/peminjaman', [AdminController::class, 'listPeminjaman'])->name('peminjaman.index');
...
Route::middleware(['auth', 'role:peminjam'])->prefix('peminjam')->name('peminjam.')->group(function () {
    ...
    // Pengembalian barang
    Route::get('/kembali', [PeminjamController::class, 'daftarBarangDipinjam'])->name('kembali');
    Route::post('/peminjaman/{id}/kembali', [PeminjamController::class, 'kembalikanBarang'])->name('peminjaman.kembali');
