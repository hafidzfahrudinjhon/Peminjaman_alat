        ...
        <div class="flex items-center gap-3 w-full md:w-auto">
            ...
            <form action="{{ route('admin.peminjaman.index') }}" method="GET" class="flex w-full md:w-80">
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari nama peminjam / status..."
                    class="w-full px-3 py-2 text-sm border border-gray-300 border-r-0 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <tr class="hover:bg-gray-50 transition align-top">
                    ...
                    <td class="py-3 px-4 border-b">
                        <span class="px-2.5 py-1 text-xs font-semibold rounded-full
                            ...
                            @elseif(in_array($peminjaman->status, ['selesai', 'dikembalikan'])) bg-emerald-100 text-emerald-800
